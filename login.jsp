...
<body>
							...
							<div class="form-group">
								<label for="username"><i
									...
									type="text" name="username" id="username"
                                                                        placeholder="Your Name" required/><span class="email"></span>
							</div>
							<div class="form-group">
								<label for="password"><i class="zmdi zmdi-lock"></i></label> <input
									type="password" name="password" id="password"
                                                                        placeholder="Password" required/><span class="password"></span>
							</div>
							<div class="form-group">
	...
	<link rel="stylesheet" href="alert/dist/sweetalert.css">
        ...
        <script>
            ...
            if(status == "failed"){
                swal("Sorry","Wrong username or password or Type","error");
            }
            if(status == "Invalid Email"){
                swal("Sorry","User Name is Mandatory","error");
            }
            if(status == "Invalid Password"){
                swal("Sorry","Password is Mandatory","error");
            }
            if(status == "Invalid Type"){
                swal("Sorry","Type is Mandatory","error");
            }
        </script>
